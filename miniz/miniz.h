...
#else
#define MZ_MALLOC(x) jo_malloc(x)
#define MZ_FREE(x) jo_free(x)
#define MZ_REALLOC(p, x) my_realloc(p, x)
#endif

#define MZ_MAX(a, b) (((a) > (b)) ? (a) : (b))
#define MZ_MIN(a, b) (((a) < (b)) ? (a) : (b))
#define MZ_CLEAR_OBJ(obj) jo_memset(&(obj), 0, sizeof(obj))
